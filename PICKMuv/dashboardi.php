...
echo $action2;
$addmov1 = strtolower($moviename1);
$addmuv1 = str_replace(" ", "_", $addmov1);
require('simple_html_dom.php');
$html1 = file_get_html('https://www.rottentomatoes.com/m/'.$addmuv1);
$rate1 = $html1->find('span.meter-value.superPageFontColor' , 0);
$rottom1 =  $rate1->plaintext;

$addmov2 = strtolower($moviename2);
$addmuv2 = str_replace(" ", "_", $addmov2);
$html2 = file_get_html('https://www.rottentomatoes.com/m/'.$addmuv2);
$rate2 = $html2->find('span.meter-value.superPageFontColor' , 0);
$rottom2  = $rate2->plaintext;

$muv1 = str_replace(" ", "%20", $moviename2);
$s1 = '/search?source=hp&ei=dCpAXISzCIPHrQGd14GwDA&q='.$muv1.'&btnK=Google+Search&oq='.$muv1.'&gs_l=psy-ab.3..35i39j0i67j0i20i263j0l2j0i131l2j0j0i131j0.1214.2855..3211...0.0..0.290.1709.0j4j4......0....1..gws-wiz.....0.CjUu6ojPm2c';
$link1 = 'https://www.google.com'.$s1;
$html3 = file_get_html($link1);
$rateq3 = $html1->find('div.sDYTm', 0);
$rate3 = $rateq3->plaintext;
$n3 = strlen($rate3);
$imdb1 = '';
for ($x = 0; $x <= $n-7; $x++) {
    $imdb1 = $imdb1.$rate3[$x];
...
$muv2 = str_replace(" ", "%20", $moviename2);
$s2 = '/search?source=hp&ei=dCpAXISzCIPHrQGd14GwDA&q='.$muv2.'&btnK=Google+Search&oq='.$muv2.'&gs_l=psy-ab.3..35i39j0i67j0i20i263j0l2j0i131l2j0j0i131j0.1214.2855..3211...0.0..0.290.1709.0j4j4......0....1..gws-wiz.....0.CjUu6ojPm2c';
$link2 = 'https://www.google.com'.$s2;
$html4 = file_get_html($link2);
$rateq4 = $html1->find('div.sDYTm', 0);
$rate4 = $rateq4->plaintext;
$n4 = strlen($rate4);
$imdb2 = '';
for ($x = 0; $x <= $n-7; $x++) {
    $imdb2 = $imdb2.$rate4[$x];
...
var rtm1 = "<?php echo $rottom1 ?>";
var rtm2 = "<?php echo $rottom2 ?>";
document.getElementById("rtm1").innerHTML = "Rotton Tomatoes " + rtm1;
document.getElementById("rtm2").innerHTML = "Rotton Tomatoes " + rtm2;

var im1 = "<?php echo $imdb1 ?>";
var im2 = "<?php echo $imdb2 ?>";
document.getElementById("im1").innerHTML = "IMDB " + im1;
document.getElementById("im2").innerHTML = " IMDB " + im2;
</script>
</body>
</html>
